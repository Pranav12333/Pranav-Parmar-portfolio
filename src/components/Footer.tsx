    ...
    <footer className="border-t border-slate-200 px-4 py-10 sm:px-6 lg:px-8 dark:border-slate-800">
      <div className="mx-auto flex max-w-6xl flex-col items-center gap-6 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          ...
          <a href={profile.socials.instagram} target="_blank" rel="noreferrer" aria-label="Instagram" data-cursor="hover" className="text-slate-500 transition-all duration-300 hover:-translate-y-1 hover:scale-125 hover:text-blue-500">
            <FaInstagram size={20} />
          </a>
          <a href={profile.socials.stackoverflow} target="_blank" rel="noreferrer" aria-label="Stack Overflow" data-cursor="hover" className="text-slate-500 transition-all duration-300 hover:-translate-y-1 hover:scale-125 hover:text-blue-500">
